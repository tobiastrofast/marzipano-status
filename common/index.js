...
(function() {
  ...
  var scenes = data.scenes.map(function(data) {
    ...
    // Create perm hotspots.
    data.permHotspots.forEach(function(hotspot) {
      var element = createPermHotspotElement(hotspot);
      scene.hotspotContainer().createHotspot(element, { yaw: hotspot.yaw, pitch: hotspot.pitch });
    });
  ...
  //PermHotspot creation function added by Tobias for hotshpot that should be visible on the initial view.
  function createPermHotspotElement(hotspot) {
